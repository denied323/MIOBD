...
public interface ZapytaniaRepository extends Neo4jRepository<Samochod, Long> {
    ...
    @Query("match (a:Samochod)-[d:Stan]->(b:Ubezpieczyciel), " +
            ...
            "where a.nazwa = $nazwaSamochodu AND d.stan = $nazwaStanu AND e.pojemnoscSilnika = $nazwaPojemnoscSilnika AND f.typSilnika = $nazwaTypSilnika AND g.typUbezpieczenia = $nazwaTypuUbezpieczenia " +
