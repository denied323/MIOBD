...
public interface Link4Repository extends Neo4jRepository<Samochod, Long> {

    @Query("Match (a:Samochod),(b:Ubezpieczyciel) WHERE a.nazwa = 'Audi 80' AND b.nazwa = 'Link 4'\n" +
            "CREATE (a)-[s1stan1:Stan {stan: 'bezwypadkowy', cena: 1.352}]->(b)\n" +
            "CREATE (a)-[s1stan2:Stan {stan: 'wypadkowy', cena: 2.5}]->(b)\n" +
            ...
            "CREATE (a)-[s1tu1:TypUbezpieczenia {typUbezpieczenia: 'OC', cena: 1.2852}]->(b)\n" +
            "CREATE (a)-[s1tu2:TypUbezpieczenia {typUbezpieczenia: 'AC', cena: 1.99}]->(b)\n" +
            "CREATE (a)-[s1r1:Rok {cena: 0.0024}]->(b)\n" +
            "CREATE (a)-[s1d1:Drzwi {drzwi: 'cztero-drzwiowe', cena: 1.0}]->(b)\n")
    void audi80();


    @Query("Match (a:Samochod),(b:Ubezpieczyciel) WHERE a.nazwa = 'Mitsubishi Carisma' AND b.nazwa = 'Link 4'\n" +
            "CREATE (a)-[s1stan1:Stan {stan: 'bezwypadkowy', cena: 1.352}]->(b)\n" +
            "CREATE (a)-[s1stan2:Stan {stan: 'wypadkowy', cena: 2.825}]->(b)\n" +
    ...
    @Query("Match (a:Samochod),(b:Ubezpieczyciel) WHERE a.nazwa = 'Toyota Ercel' AND b.nazwa = 'Link 4'\n" +
            "CREATE (a)-[s1stan1:Stan {stan: 'bezwypadkowy', cena: 1.352}]->(b)\n" +
            "CREATE (a)-[s1stan2:Stan {stan: 'wypadkowy', cena: 2.825}]->(b)\n" +
            ...
            "CREATE (a)-[s1ts1:TypSilnika {typSilnika: 'benzynowy', cena: 1.5}]->(b)\n" +
            "CREATE (a)-[s1ts2:TypSilnika {typSilnika: 'diesel', cena: 1.6}]->(b)\n" +
            "CREATE (a)-[s1tu1:TypUbezpieczenia {typUbezpieczenia: 'OC', cena: 1.1852}]->(b)\n" +
            "CREATE (a)-[s1tu2:TypUbezpieczenia {typUbezpieczenia: 'AC', cena: 1.99}]->(b)\n" +
    ...
    @Query("Match (a:Samochod),(b:Ubezpieczyciel) WHERE a.nazwa = 'Mazda MX-5 II (Miata)' AND b.nazwa = 'Link 4'\n" +
            "CREATE (a)-[s1stan1:Stan {stan: 'bezwypadkowy', cena: 1.352}]->(b)\n" +
            "CREATE (a)-[s1stan2:Stan {stan: 'wypadkowy', cena: 2.825}]->(b)\n" +
    ...
    @Query("Match (a:Samochod),(b:Ubezpieczyciel) WHERE a.nazwa = 'Toyota Prius' AND b.nazwa = 'Link 4'\n" +
            "CREATE (a)-[s1stan1:Stan {stan: 'bezwypadkowy', cena: 1.352}]->(b)\n" +
            "CREATE (a)-[s1stan2:Stan {stan: 'wypadkowy', cena: 2.825}]->(b)\n" +
    ...
    @Query("Match (a:Samochod),(b:Ubezpieczyciel) WHERE a.nazwa = 'Polonez Atu' AND b.nazwa = 'Link 4'\n" +
            "CREATE (a)-[s1stan1:Stan {stan: 'bezwypadkowy', cena: 1.352}]->(b)\n" +
            "CREATE (a)-[s1stan2:Stan {stan: 'wypadkowy', cena: 2.825}]->(b)\n" +
    ...
    @Query("Match (a:Samochod),(b:Ubezpieczyciel) WHERE a.nazwa = 'Tesla Roadster' AND b.nazwa = 'Link 4'\n" +
            "CREATE (a)-[s1stan1:Stan {stan: 'bezwypadkowy', cena: 1.352}]->(b)\n" +
            "CREATE (a)-[s1stan2:Stan {stan: 'wypadkowy', cena: 2.825}]->(b)\n" +
    ...
    @Query("Match (a:Samochod),(b:Ubezpieczyciel) WHERE a.nazwa = 'Lamborghini Diablo' AND b.nazwa = 'Link 4'\n" +
            "CREATE (a)-[s1stan1:Stan {stan: 'bezwypadkowy', cena: 1.352}]->(b)\n" +
            "CREATE (a)-[s1stan2:Stan {stan: 'wypadkowy', cena: 2.825}]->(b)\n" +
