...
public interface AxaRepository extends Neo4jRepository<Samochod, Long> {

    @Query("Match (a:Samochod),(b:Ubezpieczyciel) WHERE a.nazwa = 'Audi 80' AND b.nazwa = 'Axa'\n" +
            "CREATE (a)-[s1stan1:Stan {stan: 'bezwypadkowy', cena: 1.123}]->(b)\n" +
    ...
    @Query("Match (a:Samochod),(b:Ubezpieczyciel) WHERE a.nazwa = 'Mitsubishi Carisma' AND b.nazwa = 'Axa'\n" +
            "CREATE (a)-[s1stan1:Stan {stan: 'bezwypadkowy', cena: 1.123}]->(b)\n" +
            "CREATE (a)-[s1stan2:Stan {stan: 'wypadkowy', cena: 2.5}]->(b)\n" +
    ...
    @Query("Match (a:Samochod),(b:Ubezpieczyciel) WHERE a.nazwa = 'Toyota Ercel' AND b.nazwa = 'Axa'\n" +
            "CREATE (a)-[s1stan1:Stan {stan: 'bezwypadkowy', cena: 1.123}]->(b)\n" +
            "CREATE (a)-[s1stan2:Stan {stan: 'wypadkowy', cena: 2.5}]->(b)\n" +
    ...
    @Query("Match (a:Samochod),(b:Ubezpieczyciel) WHERE a.nazwa = 'Mazda MX-5 II (Miata)' AND b.nazwa = 'Axa'\n" +
            "CREATE (a)-[s1stan1:Stan {stan: 'bezwypadkowy', cena: 1.123}]->(b)\n" +
            "CREATE (a)-[s1stan2:Stan {stan: 'wypadkowy', cena: 2.5}]->(b)\n" +
    ...
    @Query("Match (a:Samochod),(b:Ubezpieczyciel) WHERE a.nazwa = 'Toyota Prius' AND b.nazwa = 'Axa'\n" +
            "CREATE (a)-[s1stan1:Stan {stan: 'bezwypadkowy', cena: 1.123}]->(b)\n" +
            "CREATE (a)-[s1stan2:Stan {stan: 'wypadkowy', cena: 2.5}]->(b)\n" +
    ...
    @Query("Match (a:Samochod),(b:Ubezpieczyciel) WHERE a.nazwa = 'Tesla Roadster' AND b.nazwa = 'Axa'\n" +
            "CREATE (a)-[s1stan1:Stan {stan: 'bezwypadkowy', cena: 1.123}]->(b)\n" +
            "CREATE (a)-[s1stan2:Stan {stan: 'wypadkowy', cena: 2.5}]->(b)\n" +
    ...
    @Query("Match (a:Samochod),(b:Ubezpieczyciel) WHERE a.nazwa = 'Lamborghini Diablo' AND b.nazwa = 'Axa'\n" +
            "CREATE (a)-[s1stan1:Stan {stan: 'bezwypadkowy', cena: 1.123}]->(b)\n" +
            "CREATE (a)-[s1stan2:Stan {stan: 'wypadkowy', cena: 2.6}]->(b)\n" +
